...
// <summary>Validator implementation for the Entity (ShoppingCartItem)</summary>
...
{
    public class ShoppingCartItem : SwoValidator<SoftwareOne.BaseLine.Entities.ShoppingCartItem>
    {
        /// <summary>
