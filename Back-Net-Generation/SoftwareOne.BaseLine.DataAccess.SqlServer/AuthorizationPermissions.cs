...
// <summary>Class represents the data access for the Entity(AuthorizationPermissions)</summary>
namespace SoftwareOne.BaseLine.DataAccess.SqlServer
{
    /// <summary>
    /// Class represents the data access for the Entity(AuthorizationPermissions)
    /// </summary>
    public partial class AuthorizationPermissions :
        Core.SqlServer.BaseRepositoryDataAccess<Entities.AuthorizationPermissions>,
        Interfaces.DataAccess.IAuthorizationPermissions
    {
        ...
        public AuthorizationPermissions(Core.DataAccess.IMainDataAccessContext contextEntities) : base(contextEntities) { }
    }
}