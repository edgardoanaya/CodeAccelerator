    ...
    public static partial class ExpressionHelper
    {
                                                      ...
                                                      string initOrder)
        {
            if (query.IsNotNull() && orderByMember.IsValid())
            {
                ...
                var orderBy = Expression.Call(
                                            typeof(Queryable),
                                            direction == Orden.Asc ? initOrder : initOrder + "Descending",
        ...
        public static Expression<Func<T, bool>> GetCriteriaWhere<T>(string fieldName, OperationExpression selectedOperator, object fieldValue)
        {
            ...
            if (prop != null && fieldValue != null)
            {
                ...
                OperationExpression enumOperationExpression = selectedOperator;
                if ((prop.PropertyType == typeof(bool) ||
                    prop.PropertyType == typeof(bool?)) &&
                    selectedOperator != OperationExpression.Equals)
                {
                    enumOperationExpression = OperationExpression.Equals;
                }
                ...
                switch (enumOperationExpression)
                {
                    ...
                    case OperationExpression.NotLike:
                    ...
                    case OperationExpression.NotStartsWith:
                    ...
                    case OperationExpression.NotEndsWith:
